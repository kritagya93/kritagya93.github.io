...
My research involves designing architectures, models, and algorithms with sound theoretical foundations and building prototype systems. In addition to my primary research directions, I am actively engaged in several ongoing projects, including **Resolving Interpretive Differences in Smart Contract Generation from Vague Legal Language**, **Federated Learning for Secure and Trustworthy AI**, **Secure Metaverse Systems Using Multimodal AI and AR/VR**, **Blockchain for Trusted Artificial Intelligence**, and **Data Cooperatives for Privacy and Security**. Together, these efforts reflect my broader goal of developing efficient, trustworthy, and practical solutions for real-world challenges in emerging technologies, with a particular focus on uncertainty, trust, privacy, and security.
...
## News
* 🎉 [8/26] Our paper "**Transformative Shift in Nuclear Energy Monitoring Through Blockchain and Smart Contract Driven Transparency and Integrity**" got accepted for publication at the <i>2026 IEEE 8th International Conference on Blockchain Computing and Applications (BCCA 2026)</i> in Barcelona, Spain.
